  ...
  quiz: [
    {
      ...
      options: ['"true"', 'true', '1'],
      correctIndex: 1,
      why: 'Only bare true (no quotes) is a boolean. "true" in quotes is a string that happens to spell the word, and 1 is a number. Three lookalikes, three different types.',
    },
    {
      question: 'What type is 3.5?',
      options: ['decimal', 'number', 'string'],
      correctIndex: 1,
    ...
    {
      question: 'A user types 100 into a form on a web page. What does the program most likely receive?',
      options: [
        'The number 100',
        'The string "100" — text from a text box',
        'A boolean',
      ],
      correctIndex: 1,
      why: 'Form inputs deliver TEXT — everything typed into a text box arrives as a string, even digits. Forgetting this is one of the most common real-world bugs, and as a tester you’ll write cases that catch exactly it.',
    },
  ],
  teachBack: {
    prompt:
