...
export const lesson17: LessonDef = {
  ...
  quiz: [
    {
      question: 'let score; console.log(score); — what prints?',
      options: ['0', 'undefined', 'ReferenceError'],
      correctIndex: 1,
    ...
    {
      question: 'You’re reading an API response and a field says "spouse": null. What is it telling you?',
      options: [
        'The server forgot to fill in this field',
        'The field exists and is deliberately empty — this person has no spouse',
        'The server crashed while producing this field',
      ],
      correctIndex: 1,
      why: 'null is the programmer’s nothing — a purposeful statement of emptiness. A forgotten field would simply be absent (reading it would give undefined). Distinguishing the two is bread-and-butter API testing.',
    },
    {
      question: 'What value does the expression 5 === 4 produce?',
      options: ['An error — 5 doesn’t equal 4', 'false — a boolean answer to a yes/no question', 'null'],
      correctIndex: 1,
