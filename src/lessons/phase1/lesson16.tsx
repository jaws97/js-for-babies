...
export const lesson16: LessonDef = {
  ...
  quiz: [
    {
      question: 'let word = "QA"; — what is word[1]?',
      options: ['Q', 'A', '1'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: ['10', '"55" — two strings glued into a longer string', 'An error'],
      correctIndex: 1,
      why: 'Both values are strings, so + couples the trains: "55". No math happened — these are characters, not numbers. Keep this one warm; lesson 1.9 asks what happens when "5" + 5 mixes the types…',
    },
    {
      question: 'What does `Score: ${10 * 2}` produce?',
      options: ['Score: ${10 * 2}', 'Score: 20 — the slot is evaluated first, then filled in', 'An error — math isn’t allowed inside text'],
      correctIndex: 1,
