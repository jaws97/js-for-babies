...
export const lesson05: LessonDef = {
  ...
  quiz: [
    ...
    {
      question: 'An error appeared at line 12 of your program. What do we know about lines 1–11?',
      options: [
        'They were cancelled when the error happened',
        'They already ran — an error stops the program AT the failure point, not before it',
        'They will run after you close the error',
      ],
      correctIndex: 1,
      why: 'Execution is top-to-bottom, and the error is a stop sign at line 12. Everything above it already executed and its effects are real. That border between “ran” and “never ran” is often the biggest clue for finding the bug.',
    },
    {
      question: 'Red text fills the console — several errors at once. Where do you start?',
      options: [
        'The last error — it’s the most recent',
        'The first error — the later ones are often just fallout from it',
        'Restart and hope they go away',
      ],
      correctIndex: 1,
      why: 'One real problem often triggers a cascade. Fix the first error and re-run — the rest frequently vanish. (And if red text makes your heart jump: that fades with every error you read. It really does.)',
    },
  ],
  teachBack: {
    prompt:
